...
|---|---|---|---|
| Delta (Δ) | Call: e^(-qT)·N(d1) / Put: -e^(-qT)·N(-d1) | [-1, 1] | Sensitivity of option price to a ($1.00) move in the underlying. An ATM option (Delta ~0.5) gains ($0.50) when S rises by $1. |
